    ...
    >
      ...
      >
        ...
        >
          ...
          <el-descriptions-item
            :label="t('security.dataRecycleLog.Data table primary key')"
          >
            {{ baTable.form.extend!.info.primary_key }}
          </el-descriptions-item>
          <el-descriptions-item
            :label="t('security.dataRecycleLog.Operator IP')"
          >
          ...
          <el-descriptions-item
            :width="120"
            :span="2"
            :label="t('security.dataRecycleLog.Deleted data')"
            label-class-name="color-red"
          >
            <el-tree
              class="table-el-tree"
              :data="baTable.form.extend!.info.data"
...
const onRestore = (id: string) => {
  ElMessageBox.confirm(
    t("security.dataRecycleLog.Are you sure to restore the selected records?"),
    "",
    {
