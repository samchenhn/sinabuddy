...
export default {
  ...
  "Database connection help":
    "You can configure multiple database connections in config/database.php and select it here",
  layouts: {
    ...
    "Background page switching animation":
      "Background page switching animation",
    ...
    "Side menu active item background color":
      "Background color of the side menu activation item",
    "Side menu active item text color": "Side menu activation item text color",
    "Show side menu top bar (logo bar)":
      "Display the top bar of the side menu (Logo Bar)",
    "Side menu top bar background color":
      "Background color of the top bar of the side menu ",
    ...
    "Background color when hovering over the top bar":
      "Top bar hover background color",
    "Top bar menu active item background color":
      "Background color of the top bar activation item",
    "Top bar menu active item text color":
      "Top bar menu activation item text color",
    ...
    "Full screen is not supported":
      "Your browser does not support full screen, please change another browser and try again~",
    "Member center": "Member center",
    "Member information": "Member information",
    "Login to the buildadmin": "Login to the buildadmin",
    "Please enter buildadmin account name or email":
      "Please enter buildadmin account name or email",
    "Please enter the buildadmin account password":
      "Please enter the buildadmin account password",
    Login: "Login",
    Password: "Password",
    Username: "Username",
  ...
  terminal: {
    ...
    "Failure to execute this command will block the execution of the queue":
      "Failed to execute this command will block queue execution.",
    "NPM package manager": "NPM package manager",
    "NPM package manager tip":
      "Select an available package manager for the execution of commands such as npm install in the WEB terminal",
    "Clear successful task": "Clear successful task",
    "Clear successful task tip":
      "When you start a new task, automatically clear the list of already successful tasks",
    ...
    "Failed to modify the source command, Please try again manually":
      "Failed to modify the source command. Please try again manually.",
  },
  vite: {
    Later: "稍后",
