      ...
      <el-col class="lg-mb-20" :xs="24" :sm="24" :md="24" :lg="10">
        <div class="admin-info">
          ...
          >
            <el-image
              fit="cover"
              :src="fullUrl(state.adminInfo.avatar)"
              class="avatar"
            >
              <template #error>
          ...
          <div class="admin-info-base">
            ...
            <div class="admin-other">
              <div>
                {{ t("routine.adminInfo.Last logged in on") }}
                {{ state.adminInfo.last_login_time }}
              </div>
            </div>
          </div>
          <div class="admin-info-form">
            ...
            >
              <el-form-item :label="t('routine.adminInfo.user name')">
                <el-input
                  disabled
                  v-model="state.adminInfo.username"
                ></el-input>
              </el-form-item>
              <el-form-item
                :label="t('routine.adminInfo.User nickname')"
                prop="nickname"
              >
                <el-input
                  :placeholder="t('routine.adminInfo.Please enter a nickname')"
                  v-model="state.adminInfo.nickname"
                ></el-input>
              </el-form-item>
              <el-form-item
                :label="t('routine.adminInfo.e-mail address')"
                prop="email"
              >
                <el-input
                  :placeholder="
                    t('Please input field', {
                      field: t('routine.adminInfo.e-mail address'),
                    })
                  "
              ...
              <el-form-item
                :label="t('routine.adminInfo.phone number')"
                prop="mobile"
              >
                <el-input
                  :placeholder="
                    t('Please input field', {
                      field: t('routine.adminInfo.phone number'),
                    })
                  "
              ...
              <el-form-item
                :label="t('routine.adminInfo.autograph')"
                prop="motto"
              >
                <el-input
                  @keyup.enter.stop=""
                  ...
                  :placeholder="
                    t(
                      'routine.adminInfo.This guy is lazy and doesn write anything',
                    )
                  "
                  type="textarea"
              ...
              <el-form-item
                :label="t('routine.adminInfo.New password')"
                prop="password"
              >
                <el-input
                  type="password"
                  :placeholder="
                    t('routine.adminInfo.Please leave blank if not modified')
                  "
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
  nickname: [
    buildValidatorData({
      name: "required",
      title: t("routine.adminInfo.User nickname"),
    }),
  ],
  email: [
    buildValidatorData({
      name: "email",
      title: t("routine.adminInfo.e-mail address"),
    }),
  ],
  mobile: [
    buildValidatorData({
