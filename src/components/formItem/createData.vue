  ...
  <div>
    ...
    <FormItem
      ...
      :input-attr="{
        rows: 3,
        placeholder: t(
          'utils.One line at a time, without quotation marks, for example: key1=value1',
        ),
        onChange: updateValue,
    ...
    <FormItem
      ...
      :input-attr="{
        onChange: updateValue,
        placeholder: t(
          'utils.One attribute per line without quotation marks(formitem)',
        ),
    ...
    <FormItem
      ...
      :input-attr="{
        onChange: updateValue,
        placeholder: t(
          'utils.Extended properties of Input, one line without quotation marks, such as: size=large',
        ),
...
const updateValue = () => {
  emits("update:modelValue", {
    ...
    dict: dictExistsType.includes(form.type.value ?? "")
      ? (form.dict.value ?? "")
      : "",
