export default {
  "Captcha loading failed, please click refresh button":
    "Captcha loading failed, please click refresh button",
  ...
  "Please enter the correct account":
    "The account requires 3 to 15 characters and contains a-z A-Z 0-9 _",
  "Please enter the correct password":
    "The password requires 6 to 32 characters and cannot contains & < > \" '",
