      ...
      >
        ...
        >
          <FormItem
            ...
            :placeholder="
              t(
                'security.dataRecycle.The rule name helps to identify deleted data later',
              )
            "
          />
          <FormItem
            ...
            :placeholder="
              t(
                'security.dataRecycle.The data collection mechanism will monitor delete operations under this controller',
              )
            "
          />
          <FormItem
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
  name: [
    buildValidatorData({
      name: "required",
      title: t("security.dataRecycle.Rule name"),
    }),
  ],
  controller: [
    buildValidatorData({
      ...
      message: t("Please select field", {
        field: t("security.dataRecycle.controller"),
      }),
    }),
  ],
  data_table: [
    buildValidatorData({
      ...
      trigger: "change",
      message: t("Please select field", {
        field: t("security.dataRecycle.data sheet"),
      }),
    }),
  ],
  primary_key: [
    buildValidatorData({
      name: "required",
      trigger: "change",
      title: t("security.dataRecycle.Data table primary key"),
    }),
  ],
});
...
const onTableChange = () => {
  ...
  getTablePk(
    baTable.form.items!.data_table,
    baTable.form.items!.connection,
  ).then((res) => {
