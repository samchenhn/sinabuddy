export default {
  ...
  "Purchased, can be installed directly":
    "Purchased, can be installed directly",
  ...
  // commonDone
  "Congratulations, module installation is complete":
    "Congratulations, module installation is complete.",
  "Module is disabled": "Module is disabled.",
  "Congratulations, the code of the module is ready":
    "Congratulations, the code of the module is ready.",
  "Unknown state": "Unknown state.",
  "Do not refresh the page!": "Do not refresh the page!",
  "New adjustment of dependency detected":
    "New adjustment of dependency detected",
  ...
  "This module does not add new dependencies":
    "This module does not add new dependencies.",
  "There is no adjustment for system dependency":
    "There is no adjustment for system dependency.",
  please: "please",
  "After installation 1": "After installation",
  "Manually clean up the system and browser cache":
    "Manually clean up the system and browser cache.",
  "After installation 2": "After installation",
  "Automatically execute reissue command?":
    "Automatically execute reissue command?",
  "End of installation": "End of installation",
  "Dependency installation fail 1":
    "The dependency installation failed. Please click the retry button in the ",
  ...
  "The module declares the added dependencies":
    "The module declares the added dependencies",
  ...
  Install: "Install",
  "Installation cancelled because module already exists!":
    "Installation cancelled because module already exists!",
  "Installation cancelled because the directory required by the module is occupied!":
    "Installation cancelled because the directory required by the module is occupied!",
  "Installation complete": "Installation complete",
  "A conflict is found Please handle it manually":
    "A conflict is found. Please handle it manually",
