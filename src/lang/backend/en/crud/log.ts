export default {
  ...
  "Upload the selected design records to the cloud for cross-device use":
    "Upload the selected design records to the cloud for cross-device use",
  "Design records that have been synchronized to the cloud":
    "Design records that have been synchronized to the cloud",
  "Cloud record": "Cloud record",
  Settings: "Settings",
  "Login for backup design": "Login for backup design",
  "CRUD design record synchronization scheme":
    "CRUD design record synchronization scheme",
  Manual: "Manual",
  automatic: "automatic",
