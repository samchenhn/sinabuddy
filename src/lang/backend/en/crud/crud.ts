export default {
  ...
  "Are you sure to delete the generated CRUD code?":
    "Are you sure to delete the generated CRUD code?",
  start: "Start",
  create: "Create",
  "New background CRUD from zero": "New background CRUD from zero",
  "Select Data Table": "Select Data Table",
  "Select a designed data table from the database":
    "Select a designed data table from the database",
  "Start with previously generated CRUD code":
    "Start with previously generated CRUD code",
  "Fast experience": "Fast experience",
  "Please enter SQL": "Please enter SQL",
  "Please select a data table": "Please select a data table",
  "data sheet help":
    "The table prefix must be the same as the table prefix configured for the project",
  ...
  "experience 4 3":
    ", or after generating the code, click on the upper right corner of the terminal to",
  ...
  "The relative path to the generated code":
    "The relative path to the generated code",
  ...
  "Check model class":
    "Check whether protected $connection = '{connection}'; is configured in the above data model class",
  "There is no connection attribute in model class":
    "If no configuration is available, you can configure it manually",
  ...
  "Please select a field from the left first":
    "Please select a field from the left first",
  Common: "Common",
  ...
  "Remote drop-down association information":
    "Remote drop-down association information",
  ...
  "Please select the value field of the select component":
    "Please select the value field of the select component",
  "Please select the label field of the select component":
    "Please select the label field of the select component",
  "Fields displayed in the table": "Fields displayed in the table",
  "Please select the fields displayed in the table":
    "Please select the fields displayed in the table",
  "Controller position": "Controller position",
  "Please select the controller of the data table":
    "Please select the controller of the data table",
  "Data Model Location": "Data Model Location",
  "Data source configuration type": "Data source configuration type",
  "Fast configuration with generated controllers and models":
    "Fast configuration with generated controllers and models",
  ...
  "If the remote interface query involves associated query of multiple tables, enter the alias of the primary data table here":
    "If the remote interface query involves associated query of multiple tables, enter the alias of the primary data table here",
  "Please select the data model location of the data table":
    "Please select the data model location of the data table",
  ...
  "Please enter the correct table name!":
    "Please enter the correct table name!",
  "Use lower case underlined for table names":
    "Use lower case underlined for table names",
  "Please design the primary key field!":
    "Please design the primary key field!",
  "It is irreversible to give up the design Are you sure you want to give up?":
    "It is irreversible to give up the design. Are you sure you want to give up?",
  "There can only be one primary key field":
    "There can only be one primary key field.",
  "Drag the left element here to start designing CRUD":
    "Drag the left element here to start designing CRUD",
  ...
  "The menu rule with the same name already exists The menu and permission node will not be created in this generation":
    "The menu rule with the same name already exists The menu and permission node will not be created in this generation",
  "For example: `user table` will be generated into `user management`":
    "For example: `user table` will be generated into `user management`",
  ...
  designChangeTips:
    "When unchecked, the change will not be synchronized to the data table (the table structure has been manually modified, etc)",
  ...
  Yes: "Yes",
  No: "No",
  "If the data is abnormal, repeat the previous step":
    "If the data is abnormal, repeat the previous step",
