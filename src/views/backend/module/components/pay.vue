        ...
        <div class="header-box">
          <img
            ...
            :src="
              ...
              (state.common.payType == 'wx' ? 'wechat-pay.png' : 'alipay.png')
            "
            alt=""
          />
        </div>
        <div class="pay-box">
          <div class="left">
            <div class="order-info">
              ...
              <div class="order-info-items">
                {{ t("module.Purchase user") }}：{{
                  specificUserName(baAccount)
                }}
              </div>
              <div class="order-info-items">
            ...
            <div class="pay_qr">
              <QrcodeVue
                v-if="state.common.payType == 'wx'"
                :value="state.payInfo.pay.code_url"
                :size="220"
                :margin="0"
                level="H"
              />
              ...
              <div
                v-if="state.payInfo.pay.status == 'success'"
                class="pay-success"
              >
                <Icon
                  name="fa fa-check"
            ...
            <el-alert class="qr-tips" :closable="false" type="success" center>
              <div class="qr-tips-content">
                <Icon
                  color="var(--el-color-success)"
                  :name="
                    state.common.payType == 'wx'
                      ? 'fa fa-wechat'
                      : 'fa fa-buysellads'
                  "
                />
                <span v-if="state.common.payType == 'wx'">{{
                  t("module.Use WeChat to scan QR code for payment")
                }}</span>
                <span v-if="state.common.payType == 'zfb'">{{
          ...
          <div class="right">
            <img
              ...
              :src="
                ...
                (state.common.payType == 'wx' ? 'wechat.png' : 'alipay.png')
              "
              alt=""
            />
          </div>
