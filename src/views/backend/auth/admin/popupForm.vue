        ...
        >
          ...
          <FormItem
            ...
            :input-attr="{
              ...
              params: {
                isTree: true,
                absoluteAuth: adminInfo.id == baTable.form.items!.id ? 0 : 1,
              },
              field: 'name',
          ...
          <FormItem
            ...
            type="string"
            :placeholder="
              t('Please input field', { field: t('auth.admin.email') })
            "
          />
          <FormItem
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
  ...
  group_arr: [
    buildValidatorData({
      name: "required",
      message: t("Please select field", { field: t("auth.admin.group") }),
    }),
  ],
  email: [
    buildValidatorData({
