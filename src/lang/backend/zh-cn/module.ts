export default {
  ...
  "dependency-installation-fail-tips":
    "若手动执行命令成功，可点击以上的 `确定依赖已准备好` 将模块修改为已安装状态。",
  "New version": "有新版本",
  Install: "安装",
  ...
  "Restart Vite hot server tips":
    "在完成服务重启之前，您还可以随时从顶栏右侧的按钮组中找到手动重启服务的按钮。",
  "Manual restart": "手动重启",
  "Restart Now": "立即重启",
};
