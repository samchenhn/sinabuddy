export default {
  ...
  "Automatic cancellation due to duplicate request:":
    "Automatic cancellation due to duplicate requests:",
  ...
  "The same data already exists in the system!":
    "The same data already exists on the system!",
  ...
  "Abnormal problem, please contact the website administrator!":
    "Abnormal problems, please contact the website administrator!",
