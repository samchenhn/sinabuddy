<template>
  ...
  <div v-bind="$attrs" class="table-header ba-scroll-style">
    ...
    <el-tooltip
      ...
      :content="
        (baTable.table.expandAll ? t('Shrink') : t('Open')) + t('All submenus')
      "
      placement="top"
    >
      <el-button
        v-blur
        @click="
          baTable.onTableHeaderAction('unfold', {
      ...
      >
        <span class="table-header-operate-text">{{
          baTable.table.expandAll ? t("Shrink all") : t("Expand all")
        }}</span>
      </el-button>
    </el-tooltip>
    ...
    <div class="table-search">
      ...
      <el-input
        ...
        @input="onSearchInput"
        :placeholder="
          quickSearchPlaceholder ? quickSearchPlaceholder : t('Search')
        "
        clearable
      />
      <div
