        ...
        <el-form :model="configStore.layout">
          <div class="layout-mode-styles-box">
              ...
              <el-row class="layout-mode-box-style-row" :gutter="10">
                <el-col :span="12">
                  ...
                  >
                    ...
                    <div class="layout-mode-style-name">
                      {{ t("layouts.default") }}
                    </div>
                  </div>
                </el-col>
            ...
            <div class="layout-config-global">
              ...
              <el-form-item
                :label="t('layouts.Background page switching animation')"
              >
                <el-select
            ...
            <div class="layout-config-aside">
              <el-form-item
                :label="t('layouts.Side menu bar background color')"
              >
                <el-color-picker
              ...
              <el-form-item
                :label="t('layouts.Side menu active item background color')"
              >
                <el-color-picker
              ...
              <el-form-item
                :label="t('layouts.Side menu active item text color')"
              >
                <el-color-picker
              ...
              <el-form-item
                :label="t('layouts.Show side menu top bar (logo bar)')"
              >
                <el-switch
            ...
            <div class="layout-config-aside">
              ...
              <el-form-item
                :label="
                  t('layouts.Background color when hovering over the top bar')
                "
              >
                <el-color-picker
                  @change="
              ...
              <el-form-item
                :label="t('layouts.Top bar menu active item text color')"
              >
                <el-color-picker
                  @change="
