        ...
        >
          ...
          <el-form-item prop="nickname" :label="t('user.user.nickname')">
            <el-input
              ...
              type="string"
              :placeholder="
                t('Please input field', { field: t('user.user.nickname') })
              "
            ></el-input>
          </el-form-item>
          <FormItem
          ...
          <el-form-item prop="email" :label="t('user.user.email')">
            <el-input
              ...
              type="string"
              :placeholder="
                t('Please input field', { field: t('user.user.email') })
              "
            ></el-input>
          </el-form-item>
          <el-form-item prop="mobile" :label="t('user.user.mobile')">
            <el-input
              ...
              type="string"
              :placeholder="
                t('Please input field', { field: t('user.user.mobile') })
              "
            ></el-input>
          </el-form-item>
          <FormItem
          ...
          <el-form-item :label="t('user.user.birthday')">
            <el-date-picker
              ...
              type="date"
              :placeholder="
                t('Please select field', { field: t('user.user.birthday') })
              "
            />
          </el-form-item>
          <el-form-item
          ...
          >
            <el-input v-model="baTable.form.items!.money" readonly>
              <template #append>
                <el-button @click="changeAccount('money')">{{
          ...
          <el-form-item
            v-if="baTable.form.operate == 'Edit'"
            :label="t('user.user.integral')"
          >
            <el-input v-model="baTable.form.items!.score" readonly>
              <template #append>
                <el-button @click="changeAccount('score')">{{
          ...
          <el-form-item prop="motto" :label="t('user.user.Personal signature')">
            <el-input
              ...
              :placeholder="
                t('Please input field', {
                  field: t('user.user.Personal signature'),
                })
              "
            ></el-input>
          </el-form-item>
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
  ...
  nickname: [
    buildValidatorData({ name: "required", title: t("user.user.nickname") }),
  ],
  group_id: [
    buildValidatorData({
      name: "required",
      message: t("Please select field", { field: t("user.user.group") }),
    }),
  ],
