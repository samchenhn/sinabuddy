    ...
    <div class="ba-click-captcha" :class="props.class">
      ...
      <div v-else class="captcha-img-box">
        <img
          ...
          :alt="
            i18n.global.t(
              'validate.Captcha loading failed, please click refresh button',
            )
          "
        />
        <span
      ...
      <div v-else class="captcha-prompt">
        ...
        <span
          ...
          :key="index"
          :class="state.xy.length > index ? 'clicaptcha-clicked' : ''"
        >
          {{ text }}
        </span>
      </div>
...
const props = withDefaults(defineProps<Props>(), {
  ...
  unset: false,
  error: i18n.global.t(
    "validate.The correct area is not clicked, please try again!",
  ),
