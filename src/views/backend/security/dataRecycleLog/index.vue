    ...
    <TableHeader
      ...
      :quick-search-placeholder="
        t('Quick search placeholder', {
          fields: t('security.dataRecycleLog.Rule name'),
        })
      "
    >
      <el-popconfirm
        ...
        :title="
          t(
            'security.dataRecycleLog.Are you sure to restore the selected records?',
          )
        "
        ...
        <template #reference>
          <div class="mlr-12">
            <el-tooltip
              :content="
                t(
                  'security.dataRecycleLog.Restore the selected record to the original data table',
                )
              "
              placement="top"
            >
  ...
  column: [
    ...
    },
    {
      ...
      operatorPlaceholder: t(
        "security.dataRecycleLog.Arbitrary fragment fuzzy query",
      ),
