<template>
  <div class="user-views">
    <el-card
      ...
      shadow="hover"
      :header="t('user.account.changePassword.Change Password')"
    >
      <div class="change-password">
        ...
        >
          <FormItem
            ...
            :placeholder="
              t(
                'user.account.changePassword.Please enter your current password',
              )
            "
          />
          <FormItem
            ...
            :placeholder="
              t('Please input field', {
                field: t('user.account.changePassword.New password'),
              })
            "
          />
          <FormItem
            ...
            :placeholder="
              t('Please input field', {
                field: t('user.account.changePassword.Confirm new password'),
              })
            "
          />
...
const state = reactive({
  ...
  rules: {
    oldPassword: [
      buildValidatorData({
        name: "required",
        title: t("user.account.changePassword.Old password"),
      }),
    ],
    newPassword: [
      buildValidatorData({
        name: "required",
        title: t("user.account.changePassword.New password"),
      }),
    ...
    confirmPassword: [
      buildValidatorData({
        name: "required",
        title: t("user.account.changePassword.Confirm new password"),
      }),
      buildValidatorData({ name: "password" }),
      {
          ...
          if (state.form.newPassword || state.form.confirmPassword) {
            if (state.form.newPassword == state.form.confirmPassword) {
              ...
              callback(
                new Error(
                  t(
                    "user.account.changePassword.The duplicate password does not match the new password",
                  ),
                ),
              );
            }
