        ...
        >
          <el-form-item :label="t('utils.preview')">
            <el-image
              ...
              :src="
                previewRenderFormatter(
                  baTable.form.items!,
                  {},
                  baTable.form.items!.suffix,
                )
              "
            ></el-image>
          </el-form-item>
          ...
          <el-form-item :label="t('routine.attachment.Physical path')">
            <el-input
              ...
              :placeholder="
                t(
                  'routine.attachment.File saving path Modifying records will not automatically transfer files',
                )
              "
              readonly
            ></el-input>
          ...
          <el-form-item :label="t('utils.Upload (Reference) times')">
            <el-input
              ...
              type="number"
              :placeholder="
                t('routine.attachment.Upload (Reference) times of this file')
              "
            ></el-input>
