export default {
  ...
  "no_login_valid tips":
    "游客没有会员分组，通过本选项设置当前规则是否对游客有效（可见）",
  "For example, if you add account/overview as a route only":
    "WEB 端组件路径，请以 /src 开头，如：/src/views/frontend/index.vue",
  ...
  "Component path tips":
    "组件路径在 WEB 工程内是必填的，否则无法访问，但作为 Nuxt 工程内的菜单时，无需填写此项，请根据菜单使用场景填写",
};
