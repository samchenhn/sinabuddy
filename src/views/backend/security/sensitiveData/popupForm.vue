...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
  name: [
    buildValidatorData({
      name: "required",
      title: t("security.sensitiveData.Rule name"),
    }),
  ],
  controller: [
    buildValidatorData({
      ...
      message: t("Please select field", {
        field: t("security.sensitiveData.controller"),
      }),
    }),
  ],
  data_table: [
    buildValidatorData({
      ...
      trigger: "change",
      message: t("Please select field", {
        field: t("security.sensitiveData.data sheet"),
      }),
    }),
  ],
  primary_key: [
  ...
  data_fields: [
    buildValidatorData({
      name: "required",
      message: t("Please select field", {
        field: t("security.sensitiveData.Sensitive fields"),
      }),
    }),
  ],
});
