  ...
  <div class="upload-install">
    <div class="tips">
      ...
      <div class="tip-item">
        3.
        {{
          $t("module.The module can install new front and rear dependencies")
        }}
      </div>
    </div>
    <el-upload
    ...
    >
      <template v-if="state.uploadState == 'wait-file'">
        ...
        <div class="el-upload__text">
          {{ $t("module.Drag the module package file here") }}
          <em>{{ $t("module.Click me to upload") }}</em>
        </div>
      </template>
      <el-result
        v-else
        icon="success"
        :sub-title="
          $t('module.Uploaded, installation is about to start, please wait')
        "
      ></el-result>
    </el-upload>
  </div>
