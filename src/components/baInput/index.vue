    ...
    const rc = () => {
      ...
      const vNodes = computed(() => {
        ...
        for (const key in attrs.value.content) {
          ...
          vNode.push(
            createVNode(resolveComponent("el-" + type), nodeProps, slots),
          );
        }
        return vNode;
      });
          ...
          return () =>
            createVNode(
              resolveComponent("el-input-number"),
              {
                ...
                ...attrs.value,
                modelValue: isString(props.modelValue)
      ...
      [
        ...
        () => {
          ...
          const valueType = computed(() => {
            if (
              typeof attrs.value.activeValue !== "undefined" &&
              typeof attrs.value.inactiveValue !== "undefined"
            ) {
              return "custom";
            }
              ...
              resolveComponent("el-cascader"),
              {
                ...
                props: {
                  ...
                  lazyLoad(node: any, resolve: any) {
                    ...
                    lastLazyValue.key = key;
                    lastLazyValue.value = props.modelValue;
                    lastLazyValue.currentRequest = getArea(pathValues).then(
                      (res) => {
                        let toStr = false;
                        if (
                          props.modelValue &&
                          typeof (props.modelValue as anyObj)[0] === "string"
                        ) {
                          toStr = true;
                        }
