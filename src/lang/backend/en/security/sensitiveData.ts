export default {
  ...
  "The rule name helps to identify the modified data later":
    "Rule names help to identify modified data subsequently later.",
  ...
  "Filling in field notes helps you quickly identify fields later":
    "Fill in field comments help to identify fields quickly later.",
};
