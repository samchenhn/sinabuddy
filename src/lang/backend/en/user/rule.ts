export default {
  ...
  "Type menu_dir tips":
    "Automatically register routes and serve as menu directory of member center This item cannot jump",
  "Type menu tips":
    "Automatically register routes and serve as menu items in member centers",
  "Type nav tips":
    "Routes are automatically registered as menu items in the top bar of the site",
  "Type button tips":
    "Automatic registration as a permission node, can be quickly verified by v-auth",
  "Type nav_user_menu tips":
    "Automatically register routes and serve as a dropdown menu for top bar members",
  ...
  "no_login_valid tips":
    "Tourists do not have membership groups Use this option to set whether the current rules are valid for tourists (visible)",
