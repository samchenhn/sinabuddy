<template>
  <div class="table-com-search">
    <el-form
      @submit.prevent=""
      @keyup.enter="baTable.onTableAction('com-search', {})"
      label-position="top"
      ...
      <el-row>
        <template v-for="(item, idx) in baTable.table.column" :key="idx">
          <template v-if="item.operator !== false">
            ...
            <el-col
              v-if="
                item.comSearchRender == 'customRender' ||
                item.comSearchRender == 'slot'
              "
              v-bind="{
            ...
            >
              ...
              <div class="com-search-col" :class="item.prop">
                <div
                  ...
                  v-if="item.comSearchShowLabel !== false"
                >
                  {{ item.label }}
                </div>
                <div class="com-search-col-input">
                  ...
                  <!-- 自定义渲染-slot -->
                  <slot
                    v-else-if="item.comSearchRender == 'slot'"
                    :name="item.comSearchSlotName"
                  ></slot>
                </div>
              </div>
            </el-col>
            ...
            >
              <div class="com-search-col" :class="item.prop">
                <div
                  class="com-search-col-label w16"
                  v-if="item.comSearchShowLabel !== false"
                >
                  {{ item.label }}
                </div>
            ...
            <el-col v-else :xs="24" :sm="6">
              <div class="com-search-col" :class="item.prop">
                ...
                <div
                  v-else-if="
                    item.operator == 'NULL' || item.operator == 'NOT NULL'
                  "
        ...
        <el-col :xs="24" :sm="6">
          <div class="com-search-col pl-20">
            <el-button
              v-blur
              @click="baTable.onTableAction('com-search', {})"
              type="primary"
              >{{ $t("Search") }}</el-button
            >
