<template>
  <div>
    <el-alert
      ...
      v-if="state.table.remark"
      :title="state.table.remark"
      type="info"
      show-icon
    />
    <div class="modules-header">
      <div class="table-header-buttons">
        ...
        <el-button-group class="ml10 publish-module-button-group">
          <el-button
            @click="
              navigateTo('https://doc.buildadmin.com/senior/module/start.html')
            "
            v-blur
            type="success"
          >
            ...
            <span class="table-header-operate-text">{{
              t("module.Publishing module")
            }}</span>
          </el-button>
          <el-button
            @click="
              navigateTo(
                'https://doc.buildadmin.com/guide/other/appendix/getPoints.html',
              )
            "
            v-blur
            type="success"
        ...
        <el-button
          v-blur
          class="ml10 ba-account-button"
          @click="onShowBaAccount"
          type="success"
        >
