        ...
        <el-col :lg="6" class="hidden-md-and-down">
          <div class="working">
            ...
            <div @click="onChangeWorkState()" class="working-opt working-rest">
              {{
                state.pauseWork
                  ? t("dashboard.Continue to work")
                  : t("dashboard.have a bit of rest")
              }}
            </div>
          </div>
        </el-col>
            ...
            <div class="new-user-growth">
              <el-scrollbar>
                ...
                <div class="new-user-item">
                  <img
                    class="new-user-avatar"
                    :src="fullUrl('/static/images/avatar.png')"
                    alt=""
                  />
                  <div class="new-user-base">
...
const initUserSourceChart = () => {
  ...
  const option = {
    ...
    xAxis: {
      data: [
        t("dashboard.Baidu"),
        t("dashboard.Direct access"),
        t("dashboard.take a plane"),
        t("dashboard.Take the high-speed railway"),
      ],
      axisTick: { show: false },
      axisLine: { show: false },
      axisLabel: {
