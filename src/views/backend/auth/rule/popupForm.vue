        ...
        >
          ...
          <FormItem
            ...
            :input-attr="{
              border: true,
              content: {
                menu_dir: t('auth.rule.type menu_dir'),
                menu: t('auth.rule.type menu'),
                button: t('auth.rule.type button'),
              },
            }"
          />
          ...
          <el-form-item prop="name" :label="t('auth.rule.Rule name')">
            <el-input
              ...
              :placeholder="
                t(
                  'auth.rule.English name, which does not need to start with `/admin`, such as auth/menu',
                )
              "
            ></el-input>
          ...
          >
            <el-input
              ...
              :placeholder="
                t(
                  'auth.rule.Web side component path, please start with /src, such as: /src/views/backend/dashboard',
                )
              "
            ></el-input>
          </el-form-item>
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
  ...
  url: [
    buildValidatorData({
      name: "required",
      title: t("auth.rule.Link address"),
    }),
    buildValidatorData({
      name: "url",
  ...
  component: [
    buildValidatorData({
      name: "required",
      message: t("auth.rule.Component path"),
    }),
  ],
  pid: [
    {
