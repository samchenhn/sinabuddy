<template>
  <div class="user-views">
          ...
          <div class="user-avatar-icons">
            ...
            >
              <el-tooltip
                ...
                :content="
                  (userInfo.mobile
                    ? $t('user.account.overview.Filled in')
                    : $t('user.account.overview.Not filled in')) +
    ...
    <el-card
      ...
      shadow="hover"
      :header="$t('user.account.overview.Growth statistics')"
    >
