    ...
    <el-card class="user-views-card" shadow="hover">
      <template #header>
        <div class="card-header">
          ...
          <span class="right-title">{{
            $t("user.account.integral.Current points") + " " + userInfo.score
          }}</span>
        </div>
      </template>
      <div v-loading="state.pageLoading" class="logs">
        <div class="log-item" v-for="(item, idx) in state.logs" :key="idx">
          ...
          <div class="log-after">
            {{
              $t("user.account.integral.Points after change") +
              "：" +
              item.after
            }}
          </div>
          <div class="log-change-time">
            {{
              $t("user.account.integral.Change time") +
              "：" +
