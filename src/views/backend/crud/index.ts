 ...
 */
export type TableDesignChangeType =
  | "change-field-name"
  | "del-field"
  | "add-field"
  | "change-field-attr"
...
const formBaseAttr = {
  ...
  validatorMsg: {
    ...
    placeholder: i18n.global.t(
      "crud.state.If left blank, the verifier title attribute will be filled in automatically",
    ),
    attr: {
      rows: 3,
    },
...
export const designTypes: anyObj = {
  ...
  weigh: {
    name: i18n.global.t(
      "crud.state.Weight (automatically generate drag sort button)",
    ),
    table: {
      operator: getTableAttr("operator", "RANGE"),
      sortable: getTableAttr("sortable", "custom"),
  ...
  remoteSelect: {
    ...
    form: {
      ...
      "remote-url": {
        ...
        value: "",
        placeholder: i18n.global.t(
          "crud.state.If it is not input, it will be automatically analyzed by the controller",
        ),
      },
  ...
  remoteSelects: {
    name:
      i18n.global.t("utils.remote select") +
      i18n.global.t("utils.choice") +
      i18n.global.t("crud.state.Multi"),
    table: {
      operator: getTableAttr("operator", "LIKE"),
    },
    form: {
