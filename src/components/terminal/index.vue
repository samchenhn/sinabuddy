  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-timeline
          class="terminal-timeline"
          v-if="terminal.state.taskList.length"
        >
          <el-timeline-item
            ...
            <el-card>
              ...
              <template v-if="item.status != taskStatus.Waiting">
                ...
                >
                  ...
                  <Icon
                    :name="
                      item.showMessage ? 'el-icon-ArrowUp' : 'el-icon-ArrowDown'
                    "
                    size="16"
                    color="#909399"
                  />
        ...
        <el-empty
          v-else
          :image-size="80"
          :description="t('terminal.No mission yet')"
        />
      </el-scrollbar>
      ...
      <div class="terminal-buttons">
        ...
        <el-dropdown class="terminal-menu-item">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item
                @click="addTerminalTask('web-install', true)"
              ...
              <el-dropdown-item
                ...
                >composer update</el-dropdown-item
              >
            </el-dropdown-menu>
          </template>
        </el-dropdown>
        <el-button
          ...
          v-blur
          @click="webBuild()"
          >{{ t("terminal.Republish") }}</el-button
        >
        <el-button
          class="terminal-menu-item"
          icon="el-icon-Delete"
          v-blur
          @click="terminal.clearSuccessTask()"
        >
    ...
    >
      <el-form label-position="left" label-width="140">
        <FormItem
          ...
          v-loading="
            state.registryLoading && state.registryLoadingType == 'npm'
          "
          type="select"
          :input-attr="{
            border: true,
        ...
        <FormItem
          ...
          v-loading="
            state.registryLoading && state.registryLoadingType == 'composer'
          "
          type="select"
          :input-attr="{
            border: true,
        ...
        <FormItem
          ...
          :input-attr="{
            ...
            content: {
              ...
              yarn: 'YARN',
              ni: 'NI',
              none: t('terminal.Manual execution'),
            },
            teleported: false,
      ...
      <div class="config-buttons">
        <el-button @click="terminal.toggleConfigDialog(false)">{{
...
const webBuild = () => {
  ElMessageBox.confirm(
    t("terminal.Are you sure you want to republish?"),
    t("Reminder"),
    {
  ...
  terminal.addTask(
    ...
    (res: taskStatus) => {
      ...
      if (res == taskStatus.Failed || res == taskStatus.Unknown) {
        ElMessageBox.confirm(
          t(
            "terminal.Failed to modify the source command, Please try again manually",
          ),
          t("Reminder"),
          {
            confirmButtonText: t("Confirm"),
...
const getSourceContent = (type: SourceType) => {
  ...
  if (
    terminal.state[type == "npm" ? "npmRegistry" : "composerRegistry"] ==
    "unknown"
  ) {
