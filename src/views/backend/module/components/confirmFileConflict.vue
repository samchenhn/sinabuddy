    ...
    <div class="confirm-file-conflict">
      <template v-if="state.common.disableConflictFile.length">
        ...
        <el-alert
          :closable="false"
          :center="true"
          :title="$t('module.Update warning')"
          class="alert-warning"
          type="warning"
        ></el-alert>
        <el-table
          :data="state.common.disableConflictFile"
          stripe
          border
      ...
      <template v-if="state.common.disableDependConflict.length > 0">
        ...
        <el-table
          :data="state.common.disableDependConflict"
          stripe
          border
          style="width: 100%"
        >
